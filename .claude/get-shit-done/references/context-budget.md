...
The keys live in `.claude/settings.json` (project) or `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/settings.json` (global) — **not** in `.planning/config.json`:
