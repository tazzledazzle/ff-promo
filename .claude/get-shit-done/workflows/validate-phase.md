...
```
Agent(
  prompt="Read /Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/templates/VALIDATION.md`
