...
```bash
INIT=$(node "/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
