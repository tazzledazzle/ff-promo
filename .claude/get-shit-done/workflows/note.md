...
- **Global scope**: `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/notes/`)
...
2. Glob `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/notes/` — works in any directory
