...
<!-- For checkpoint task examples and patterns, see @/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
