...
- Usage: Reference from command with `@/Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/terenceschumacher/dev/june-portfolio-projects/ff-promo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
